    ...
    def trainAgent(self):
        ...
        for i in range(self.episodes_num):
            ...
            for j in range(self.max_steps):
                ...
                noise[0][0] =  max(epsilon, 0) * self.ou.function(action[0][0],  0.0 , 0.30, 0.05)
                #if action[0][1] >=0 :
                noise[0][1] =  max(epsilon, 0) * self.ou.function(action[0][1],  0.20 , 0.70, 0.05)
                #else:
            ...
            if i % 10 == 0 and (total_reward > 100):
