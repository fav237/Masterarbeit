...
vehicle_loc = carla.Location(x=20, y=302.50, z=0.6)
vehicle_rot = carla.Rotation(pitch=0.0, yaw=-180 ,roll=0.0)
...
time.sleep(1)
print(f'waypoint location : {vehicle_trans}')


# ### route planning bit


a_loc = carla.Location(x=-10, y=45.0, z=0.3)
b_loc = carla.Location(x=-3.680, y=280.0, z=0.3)
...
route = grp.trace_route(vehicle_loc, b_loc)
